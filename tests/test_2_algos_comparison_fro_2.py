...
rank_X = np.shape(D)[0]
#print("classic bound for fro norm")
#print(np.sqrt((d-k)*k))
#print("new bound for fro norm")
...
boosting_error_fro_effective_projection_dpp_list = []
boosting_error_fro_random_effective_projection_dpp_list = []

boosting_error_fro_largest_lvs_list = []
boosting_error_fro_pivoted_qr_list = []
boosting_error_fro_double_phase_list = []

boosting_error_fro_double_phase_strong_list = []
...
for T_B in list(range(boosting_batch)):
    ...
    error_fro_list_double_phase_strong_sampling = launch_exp_double_phase_strong_sampler(X_matrix,dataset_name,k,exp_number,"fro") 
    
    error_fro_list_projection_DPP = launch_exp_projection_dpp(X_matrix,dataset_name,k,exp_number,"fro")    
    error_fro_list_effective_projection_DPP = launch_exp_effective_projection_dpp(X_matrix,dataset_name,k,exp_number,2,"fro")    
    error_fro_list_random_effective_projection_DPP = launch_exp_random_effective_projection_dpp(X_matrix,dataset_name,k,exp_number,1300,"fro")    

    error_fro_list_double_phase_sampling = launch_exp_double_phase_sampler(X_matrix,dataset_name,k,exp_number,"fro") 
    
    ##error_fro_list_derandomized_volume_sampling = launch_exp_derandomized_volume_sampling(X_matrix,dataset_name,k,exp_number)    
    error_fro_list_pivoted_qr_sampling = launch_exp_pivoted_qr_sampling(X_matrix,dataset_name,k,exp_number,"fro")
    error_fro_list_largest_lvs_sampling = launch_exp_largest_leveragescores_sampling(X_matrix,dataset_name,k,exp_number,"fro") 
    error_fro_list_optimized_projection_DPP = launch_exp_optimized_projection_dpp(X_matrix,dataset_name,k,exp_number,"fro")    
    error_fro_list_volume_sampling = launch_exp_volume_sampling(X_matrix,Y_matrix,dataset_name,k,exp_number,"fro")    
    error_fro_list_uniform_sampling = launch_exp_uniform_sampling(X_matrix,dataset_name,k,exp_number,"fro") 
    ...
    min_error_fro_list_double_phase_strong_sampling = random_error_list_to_min_error_list(error_fro_list_double_phase_strong_sampling)
    
    
    min_error_fro_list_largest_lvs_sampling = random_error_list_to_min_error_list(error_fro_list_largest_lvs_sampling)
    min_error_fro_list_pivoted_qr_sampling = random_error_list_to_min_error_list(error_fro_list_pivoted_qr_sampling)
    min_error_fro_random_effective_projection_dpp_list = random_error_list_to_min_error_list(error_fro_list_random_effective_projection_DPP)
    ...
    boosting_error_fro_double_phase_strong_list.append(min_error_fro_list_double_phase_strong_sampling)
        
    
    boosting_error_fro_random_effective_projection_dpp_list.append(error_fro_list_random_effective_projection_DPP)
    ...
    error_fro_aggregated_list.append(error_fro_list_random_effective_projection_DPP)
    error_fro_aggregated_list.append(error_fro_list_effective_projection_DPP)
    ...
    error_fro_aggregated_list.append(error_fro_list_double_phase_strong_sampling)
...
boosting_error_fro_aggregated_list.append(boosting_error_fro_random_effective_projection_dpp_list)
boosting_error_fro_aggregated_list.append(boosting_error_fro_effective_projection_dpp_list)
...
boosting_error_fro_aggregated_list.append(boosting_error_fro_double_phase_strong_list)
...
plt.gca().xaxis.set_ticklabels(["Volume S.","Projection DPP","RE Projection DPP","E Projection DPP","Largest lvs","Pivoted QR","Double Phase","Double Phase Strong"])
