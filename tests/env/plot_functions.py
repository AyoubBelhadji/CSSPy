...
def plot_approximation_errors_on_toy_datasets(cardinal_global_list,cardinal_global_list_list,error_lists,legends_list,axislabel_list,filename_list):
    ...
    count_list_1 = 0
    for cardinal_list in cardinal_lists_0:
        if count_list_1 == 0:
            plt.hlines( error_lists_0[count_list_1],cardinal_lists_0[count_list_1]-0.25,cardinal_lists_0[count_list_1+1]-0.5, label=legends_list[0],color=palette_paired(1))
        if count_list_1 > 0 and count_list_1 < len(cardinal_lists_0)-1:
            plt.hlines( error_lists_0[count_list_1],cardinal_lists_0[count_list_1]-0.5,cardinal_lists_0[count_list_1+1]-0.5, color=palette_paired(1))
        if count_list_1 == len(cardinal_lists_0)-1:
            plt.hlines( error_lists_0[count_list_1],cardinal_lists_0[count_list_1]-0.5,cardinal_lists_0[count_list_1]+0.25, color=palette_paired(1))
    ...
    for cardinal_list in cardinal_lists_0:
        if count_list_2 == 0:
            plt.hlines(error_lists_3[count_list_2], cardinal_lists_0[count_list_2]-0.25,cardinal_lists_0[count_list_2+1]-0.5, label=legends_list[3],color=palette_paired(5))
        if count_list_2 > 0 and count_list_2 < len(cardinal_lists_0)-1:
            plt.hlines(error_lists_3[count_list_2], cardinal_lists_0[count_list_2]-0.5,cardinal_lists_0[count_list_2+1]-0.5,color=palette_paired(5))
        if count_list_2 == len(cardinal_lists_0)-1:
...
def plot_approximation_errors_effective_kernel_on_toy_datasets(cardinal_global_list,cardinal_global_list_list,error_lists,legends_list,axislabel_list,filename_list):
    ...
    for cardinal_list in cardinal_lists_0:
        if count_list_1 == 0:
            plt.hlines( error_lists_0[count_list_1],cardinal_lists_0[count_list_1]-0.5,cardinal_lists_0[count_list_1+1]-0.5, label=legends_list[0],color=palette_paired(1))
        if count_list_1 > 0 and count_list_1 < len(cardinal_lists_0)-1:
            plt.hlines( error_lists_0[count_list_1],cardinal_lists_0[count_list_1]-0.5,cardinal_lists_0[count_list_1+1]-0.5, color=palette_paired(1))
        if count_list_1 == len(cardinal_lists_0)-2:
            plt.hlines( error_lists_0[count_list_1],cardinal_lists_0[count_list_1]-0.5,cardinal_lists_0[count_list_1]+0.5, color=palette_paired(1))
        count_list_1 = count_list_1 +1
    plt.scatter(cardinal_global_list_list,error_lists[1],label=legends_list[1],marker='x',color=palette_paired(0))
    count_list_2 = 0
    for cardinal_list in cardinal_lists_0:
        if count_list_2 == 0:
            plt.hlines(error_lists_3[count_list_2], cardinal_lists_0[count_list_2],cardinal_lists_0[count_list_2]+0.5, label=legends_list[3],color=palette_paired(5))
        if count_list_2 > 0 and count_list_2 < len(cardinal_lists_0)-2:
            plt.hlines(error_lists_3[count_list_2], cardinal_lists_0[count_list_2]-0.5,cardinal_lists_0[count_list_2]+0.5,color=palette_paired(5))
        if count_list_2 == len(cardinal_lists_0)-2:
            plt.hlines( error_lists_3[count_list_2],cardinal_lists_0[count_list_2]-0.5,cardinal_lists_0[count_list_2]+0.5, color=palette_paired(5))            
        count_list_2 = count_list_2 +1
    #plt.bar(cardinal_global_list,list(error_lists[3]),label=legends_list[3],edgecolor=palette_paired(5),alpha=0)
    plt.scatter(cardinal_global_list_list,error_lists[2],label=legends_list[2],marker='x',color=palette_paired(8)) ## change to 4
    ...
    #plt.title('The case k = '+str(k)+', '+str(T)+' matrices')
    #plt.xticks(map(int, Y_cov[:-1]))
    plt.legend(bbox_to_anchor=(0.695,0.34), loc="upper left")
    plt.xticks(range(int(x_index_min[0]),int(x_index_max[0])+1, 1), fontsize=12)
    figfile_title= filename_list[0]+filename_list[1]+"_matrices_number_"+filename_list[2]+"_N_"+filename_list[3]+"_"+filename_list[4]+".pdf"
