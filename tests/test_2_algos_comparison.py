...
for T_B in list(range(boosting_batch)):
    ...
    #error_fro_list_projection_DPP = launch_exp_projection_dpp(X_matrix,dataset_name,k,exp_number,V,D,V_k,"fro")    
    ...
    #error_fro_list_uniform_sampling = launch_exp_uniform_sampling(X_matrix,dataset_name,k,exp_number,V,D,V_k,"fro") 
...
savefile_name = dataset_name+"_allalgos_"+str(exp_number)+"samples_k_"+str(k)+".txt"
...
savefile_name = dataset_name+"_boosting_allalgos_"+str(exp_number)+"samples_k_"+str(k)+".txt"
