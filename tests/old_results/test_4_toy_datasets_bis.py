...
cov_test = 0.00000100*np.ones((real_dim-r))  # The "trivial" singular values in the covariance matrix (there are real_dim-r)
...
cov_1_k_3 = np.diag(np.concatenate(([100,100,100,0.1,0.000001,0.000001],cov_test)))
trace_cov_1_k_3 = np.sum(cov_1_k_3)

cov_2_k_3 = np.diag(np.concatenate(([100,10,1,0.1,0.000001,0.000001],cov_test)))
...
cov_3_k_3 = np.diag(np.concatenate(([0.1,0.1,0.1,0.1,0.000001,0.000001],cov_test)))
...
plot_results_of_multi_experiments(N,real_dim,r,200,3,mean,cov_1_k_3,static_list_1,0,"projection_spectrum_flat_spectrum_after")

plot_results_of_multi_experiments(N,real_dim,r,200,3,mean,cov_2_k_3,static_list_1,0,"smooth_spectrum_flat_spectrum_after")


plot_results_of_multi_experiments(N,real_dim,r,500,3,mean,cov_3_k_3,static_list_1,0,"identity_spectrum_flat_spectrum_after")
